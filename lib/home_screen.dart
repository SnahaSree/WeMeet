            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  //var communityId = allPosts[index]['communityId'];
                  //var communityName = post['communityName'] ?? 'Community'; // if available in post data

                  // You can create a custom PostCard widget or render post data here
                  return ListTile(
                    leading: CircleAvatar(
                      backgroundImage: NetworkImage(post['profilePic'] ?? 'https://example.com/default_avatar.png'),
                    ),
                    title: Text(post['name'] ?? 'Unknown'),
                   // subtitle: Text('from $communityName'),
                    ...
                    onTap: () {
                      // Optionally navigate to post detail page or community page
                    },
                  );
                },
              );
